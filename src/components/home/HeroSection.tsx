...
const HeroSection = () => {
  const balanceIconRef = useRef<HTMLDivElement>(null);
  
  // Animation for the scale reveal
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-block mb-2 reveal-element hidden">
              <span className="text-sm font-medium bg-royal text-white px-3 py-1 rounded-full">
                Cabinet d'Avocats
              </span>
            </div>
            
            <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-royal-dark dark:text-white leading-tight reveal-element hidden">
              Votre Défense, <br />
              <span className="text-gold">Notre Engagement</span>
            </h1>
            
            <p className="text-lg md:text-xl text-royal/80 dark:text-elegant mt-4 max-w-lg reveal-element hidden">
            ...
            <h2 className="font-playfair text-2xl text-royal dark:text-gold-light font-semibold mt-6 reveal-element hidden">
              Votre justice, notre priorité.
            </h2>
            
            <div className="flex flex-wrap gap-4 pt-4 reveal-element hidden">
          ...
          <div className="flex justify-center">
            <div 
              ref={balanceIconRef}
              className="text-9xl md:text-[10rem] animate-balance-rotate text-gold relative reveal-element hidden"
            >
              ⚖️
